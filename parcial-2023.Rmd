...
# Modificamos los niveles de material
levels(zapatos$material) <- c("A", "B")
...
```
```{r}
# Reescribir el tibble con nombres "Material A" y "Material B"
zapatos <- zapatos %>%
  mutate(Material = ifelse(material == 1, "Material A", "Material B"))

# Crear un gráfico de cuantiles para Material A
quantile_plot_material_a <- ggplot(filter(zapatos, Material == "Material A"), aes(sample = desgaste)) +
  geom_qq() +
  geom_qq_line(color = "blue") +
  labs(title = "Gráfico de Cuantiles para Material A")

# Crear un gráfico de cuantiles para Material B
quantile_plot_material_b <- ggplot(filter(zapatos, Material == "Material B"), aes(sample = desgaste)) +
  geom_qq() +
  geom_qq_line(color = "red") +
  labs(title = "Gráfico de Cuantiles para Material B")

# Crear un histograma para Material A
histogram_material_a <- ggplot(filter(zapatos, Material == "Material A"), aes(x = desgaste)) +
  geom_histogram(binwidth = 1, fill = "blue", color = "black") +
  labs(title = "Histograma para Material A", x = "Desgaste", y = "Frecuencia")

# Crear un histograma para Material B
histogram_material_b <- ggplot(filter(zapatos, Material == "Material B"), aes(x = desgaste)) +
  geom_histogram(binwidth = 1, fill = "red", color = "black") +
  labs(title = "Histograma para Material B", x = "Desgaste", y = "Frecuencia")

# Mostrar los gráficos de cuantiles y los histogramas
print(quantile_plot_material_a)
print(quantile_plot_material_b)
print(histogram_material_a)
print(histogram_material_b)
```
